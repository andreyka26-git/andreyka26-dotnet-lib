...
{
    public abstract class CustomAuthenticationHandler<TOptions> : IAuthenticationHandler where TOptions : CustomAuthenticationSchemeOptions, new()
    {
        ...
        protected CustomAuthenticationHandler(IOptionsMonitor<TOptions> options, ILoggerFactory logger, UrlEncoder encoder, ISystemClock clock)
        {
